...
class UserManager:
    def __init__(self):
        self.users = pd.read_csv("C:/Users/t.e.glavatskikh/Desktop/-eliveryInTrain-venom/venom/server/users.csv")
    ...
    def regestration(self, login, password, staffRights):
        ...
        self.users.to_csv("C:/Users/t.e.glavatskikh/Desktop/-eliveryInTrain-venom/venom/server/users.csv")
...
class OrderManager:
    def __init__(self):
        self.orders = pd.read_csv("C:/Users/t.e.glavatskikh/Desktop/-eliveryInTrain-venom/venom/server/orders.csv", index_col="index")
    ...
    def addOrder(self, orderId, carriageNumber, placeNumber, dishesId, status):
        ...
        self.orders.to_csv("C:/Users/t.e.glavatskikh/Desktop/-eliveryInTrain-venom/venom/server/orders.csv")
        return "True"
